...
export class MAAForm extends React.Component {
    ...
    onSubmit = (e) => {
        ...
        if (!this.state.description || !this.state.venditoreId) {
            ...
            this.setState(() => ({ error: '' }))
            maklerAlleinauftrag(venditore, venditore2, oggetto, startDate, endDate, prezzoDiVendita, prezzoDiVendita2, maklerProvision, sonstige)
        }
    }
    ...
    render() {
        ...
        const oggettiOptions = this.props.oggetti.map((oggetto) => ({
            value: oggetto.id, label: `${oggetto.via} ${oggetto.numeroCivico}, WE ${oggetto.numeroAppartamento}, ${oggetto.cap} ${oggetto.citta}`
        }))
            ...
            <div>
                <div className="page-header">
                    <div className="content-container">
                        <h1 className="page-header__title">Makler-Allein-Auftrag</h1>
                    </div>
                </div>
