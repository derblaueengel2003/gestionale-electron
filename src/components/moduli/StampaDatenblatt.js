...
export class StampaDatenblatt extends React.Component {
  ...
  render() {
    const acquirente = this.props.clienti.find(
      cliente => cliente.id === this.props.deal.acquirenteId
    );
    ...
    return (
      <div className='container'>
        ...
        <div>
          ...
          <p>
            {oggetto.ruecklage &&
              `Instandhaltungsrücklage: ${oggetto.ruecklage}`}
          </p>
          <p>{`Kaufpreis: ${numeral(
        ...
        <div>
          ...
          <p>
            {venditore.codiceFiscale &&
              `SteuerId-Nr. ${venditore.codiceFiscale}`}
          </p>
          <p>
            {venditore.handelsRegisterNummer &&
              `Handelsregister-Nr. ${venditore.handelsRegisterNummer}`}
          </p>
          <p>
        ...
        {this.props.deal.venditoreId2.length > 0 && (
          <div>
            ...
            <p>
              {venditore2.codiceFiscale &&
                `SteuerId-Nr. ${venditore2.codiceFiscale}`}
            </p>
            <p>
              {venditore2.handelsRegisterNummer &&
                `Handelsregister-Nr. ${venditore2.handelsRegisterNummer}`}
            </p>
            <p>
        ...
        <div>
          ...
          <p>
            {acquirente.codiceFiscale &&
              `SteuerId-Nr. ${acquirente.codiceFiscale}`}
          </p>
          <p>
            {acquirente.handelsRegisterNummer &&
              `Handelsregister-Nr. ${acquirente.handelsRegisterNummer}`}
          </p>
          <p>
        ...
        {this.props.deal.acquirenteId2.length > 0 && (
          <div>
            ...
            <p>
              {acquirente2.codiceFiscale &&
                `SteuerId-Nr. ${acquirente2.codiceFiscale}`}
            </p>
            <p>
              {acquirente2.handelsRegisterNummer &&
                `Handelsregister-Nr. ${acquirente2.handelsRegisterNummer}`}
            </p>
            <p>
