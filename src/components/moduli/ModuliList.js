...
const ModuliPage = () => (
    <div className="content-container">
        ...
        <div className="list-item"><a href='./files/Mietvertrag Erhebung-von-Daten-Pflichtigen-selbst-Transparenzpflicht-Artikel-13-DSGVO.pdf' download>Mietvertrag DSGVO</a></div>
        <div className="list-item"><a href='./files/ACCENTRO_Beratungsprotokoll_DE.pdf' download>ACCENTRO_Beratungsprotokoll_DE</a></div>
        <div className="list-item"><a href='./files/ACCENTRO_Beratungsprotokoll_EN.pdf' download>ACCENTRO_Beratungsprotokoll_EN</a></div>
        <div className="list-item"><a href='./files/ACCENTRO_Datenschutz_DE.pdf' download>ACCENTRO_Datenschutz_DE</a></div>
