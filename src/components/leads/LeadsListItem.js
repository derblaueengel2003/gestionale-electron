            ...
            <div className="row">
                <div className="col-4-of-6">
                    <Link className="link-style" to={`/leadedit/${this.props.id}`}>
                        ...
                        <div className="list-item__sub-title">{cliente ? cliente.email : this.props.leadEmail}</div>
                        <div className="list-item__sub-title">{cliente ? cliente.telefono1 : this.props.leadTelefono}</div>
