...
export class TodoForm extends React.Component {
    ...
    onTodo10Change = () => {
        ...
        this.props.startEditDeal(this.props.deal.id, { todo10: !this.state.todo10 })
    }
    onTodo11Change = () => {
            ...
            <div className="margine-basso">
                <div className="page-header">
                    <div className="content-container">
                        <h1 className="page-header__title">Todos</h1>
                    </div>
                </div>
                <div className="content-container">
                    <div className={this.state.todo1 === true ? 'list-item--paid' : ''}><label> <input
                        type="checkbox"
                        name="todo1"
                    ...
                    <div className={this.state.todo2 === true ? 'list-item--paid' : ''}><label> <input
                        type="checkbox"
                        name="todo2"
                    ...
                    <div className={this.state.todo4 === true ? 'list-item--paid' : ''}><label> <input
                        type="checkbox"
                        name="todo4"
                    ...
                    <div className={this.state.todo11 === true ? 'list-item--paid' : ''}><label> <input
                        type="checkbox"
                        name="todo11"
