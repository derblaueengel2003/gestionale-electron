...
export class OggettoForm extends React.Component {
         ...
         constructor(props) {
           ...
           this.state = {
             ...
             affittoNetto: props.oggetto
               ? (props.oggetto.affittoNetto / 100)
                   .toString()
                   .replace(/\./, ',')
               : '0',
             ...
             proprietarioId2: props.oggetto
               ? props.oggetto.proprietarioId2
               : '',
             ...
             downloadURLsMap: props.oggetto
               ? props.oggetto.downloadURLsMap
               : '',
         ...
         handleRemovePictureCover = picture => {
           ...
           if (
             downloadURLsCover === undefined ||
             downloadURLsCover.length < 1
           ) {
             downloadURLsCover = '';
           }
         ...
         handleRemovePictureGrundriss = picture => {
           ...
           if (
             filenamesGrundriss === undefined ||
             filenamesGrundriss.length < 1
           ) {
             filenamesGrundriss = '';
           }
                     ...
                     <li className='collection-item'>
                       ...
                       <div>
                         {this.state.downloadURLsCover &&
                           this.state.downloadURLsCover.map(
                             (downloadURLCover, i) => {
                               return (
                                 <span key={i}>
                                   <img
                                     className='foto'
                                     src={downloadURLCover}
                                   />
                                   <img
                                     src='/images/trash.jpg'
                                     className='cancella'
                                     onClick={() =>
                                       this.handleRemovePictureCover(i)
                                     }
                                   />
                                 </span>
                               );
                     ...
                     <li className='collection-item'>
                       ...
                       <div>
                         {this.state.downloadURLsMap &&
                           this.state.downloadURLsMap.map(
                             (downloadURLMap, i) => {
                               return (
                                 <span key={i}>
